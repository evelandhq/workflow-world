 ...
 *
 * Workflow pins have moved mid-line before (0.31.2 is one example), which is why
 * this reports an exact version rather than a line and never infers a set from a
 * minor.
 *
